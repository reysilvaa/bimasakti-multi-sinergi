...
export function InquiryResult({
  ...
  if (!inquiry) {
    return (
      <div className="lg:col-span-7">
        <Card id="inquiry-empty-state" className="p-12 text-center">
  ...
  return (
    <div className="lg:col-span-7">
      <Card id="inquiry-result-card" className="animate-card-in">
        ...
        <div className="p-6 space-y-6">
          ...
          {/* Table of periods */}
          <div>
            <h4 className="text-xs font-bold uppercase tracking-wider text-ink-800/40 mb-2.5">
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    {hasMeter && <TableHead id="th-meter">Pemakaian</TableHead>}
